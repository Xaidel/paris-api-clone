CREATE TABLE IF NOT EXISTS transaction_upload (
    ...
    content_md5 CHAR(32) NOT NULL UNIQUE,
...
CREATE INDEX IF NOT EXISTS idx_transaction_upload_uploaded_at ON transaction_upload (uploaded_at DESC);
CREATE INDEX IF NOT EXISTS idx_transaction_upload_file_name ON transaction_upload (file_name);
